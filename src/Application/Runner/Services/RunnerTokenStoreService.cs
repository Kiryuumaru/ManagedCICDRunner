...
public class RunnerTokenStoreService(ILogger<RunnerTokenStoreService> logger, IServiceProvider serviceProvider)
{
    private readonly ILogger<RunnerTokenStoreService> _logger = logger;
    private readonly IServiceProvider _serviceProvider = serviceProvider;

    private const string _edgeGroupStore = "runner_token_group_store";
